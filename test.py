...
if __name__ == '__main__':
    ...
    prev_trained_kernel_idx = 22

    update_common_shared_weights = False
    ...
    # Get the base contour fragment orientations considered in this data set
    # Each target filter can be max activated for more then one fragment rotation.
    # Get the set of fragments rotations considered for this target filter.
